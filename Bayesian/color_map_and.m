function [] = color_map_and(n, data, model)
...
plot(data(1:3*n,1), data(1:3*n,2), '*', 'Color', [0.00 0.45 0.74], ...
    'DisplayName', 'Classe 1')
plot(data(3*n+1:end,1), data(3*n+1:end,2), '*', 'Color', [0.31 0.31 0.31], ...
    'DisplayName', 'Classe 2')

title('Bayesian Color Map')
xlabel('Eixo x')
ylabel('Eixo y')
legend show
pause(0.05)
